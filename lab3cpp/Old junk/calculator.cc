...
// Konstruktorer
/*
Node::~Node(){cout << "Node destruktor" << endl;}
Number::~Number(){cout << "Number destruktor" << endl;}
Integer::~Integer(){cout << "Integer destruktor" << endl;}
Real::~Real(){cout << "Real destruktor" << endl;}
Variable::~Variable(){cout << "Variable destruktor" << endl;}
Addition::~Addition(){cout << " Addition destruktor" << endl;}
Subtraction::~Subtraction(){cout << "Subtraction destruktor" << endl;}
Multiplication::~Multiplication(){cout << "Multiplication destruktor" << endl;}
Division::~Division(){cout << "Division destruktor" << endl;}
Exponent::~Exponent(){cout << "Exponent destruktor" << endl;}
*/
...
Variable::Variable(double var) : value{var}
{
}
...
double Division::evaluate() const
{
    ...
    {
	throw logic_error("Divisionen är inte definierad!");
    }
    return operand1->evaluate() / operand2->evaluate();
}
...
double Exponent::evaluate() const
{
    ...
    {
	throw logic_error("Exponentieringen är inte definierad!");
    }
...
Node* Variable::copy()
{
    Node* new_copy = new Variable(value);
    return new_copy;
}
